...
public class Doctor {
	...
	public Doctor(long doctorId,String f_name, String l_name, String qualification, String university,
			String specialization, int passing_year, String license_no, String email_id, boolean is_valid, long mobile,
			String password, char gender, Date dob, ClinicAddress addr) {
		super();
	...
	public ClinicAddress getAddr() {
		return addr;
	}

	public void setAddr(ClinicAddress addr) {
		this.addr = addr;
	}
